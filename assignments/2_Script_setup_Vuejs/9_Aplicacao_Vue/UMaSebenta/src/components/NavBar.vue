    ...
    <nav class="navbar is-success" role="navigation" aria-label="main navigation">
        <div class="container is-max-desktop">
            <div class="navbar-brand">
                ...
                <a @click.prevent="$event => showMobileNav = !showMobileNav"  class="navbar-burger" :class="{ 'is-active' : showMobileNav}" role="button" aria-label="menu" aria-expanded="false" data-target="navbarBasicExample">
